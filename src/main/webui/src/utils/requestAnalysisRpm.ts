...
export type RpmArchChoice = "x86_64" | "amd64" | "aarch64" | "arm64" | "ppc64le" | "s390x";
...
export function isRpmArchChoice(value: string): value is RpmArchChoice {
  return (RPM_ARCH_CHOICES as readonly string[]).includes(value);
}
